...
namespace ICTEAS.WinForms.Controls
{
    ...
    public class TreeGridViewHeaderExtender : Component, ISupportInitialize
    {
        #region "     Designer.cs     "
        /// <summary>
        ...
        #region "     Constructor     "
        public TreeGridViewHeaderExtender()
        {
            InitializeComponent();
            _Header = new TreeGridViewHeader();
        }
        #endregion

        #region "     Constructor Overload     "
        public TreeGridViewHeaderExtender(IContainer container)
        {
            container.Add(this);
        ...
        private TreeGridViewHeader _Header;
        ...
        public TreeGridView DataGridView
        {
            get { return _grid; }
            set
            {
        ...
        public TreeGridViewHeader Header
        {
            get { return _Header; }
        }
        ...
        private void AdjustHeaderControlToGrid()
        {
            ...
            switch (_HeaderPosition)
            {
                case HeaderPosition.Top:
                    ...
                    _Header.Left = _grid.Left+_grid.RowHeadersWidth;
