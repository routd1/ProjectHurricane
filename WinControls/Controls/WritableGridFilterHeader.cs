...
{
    public class WritableGridFilterHeader : DataGridViewColumnHeaderCell
    {
        ...
        public WritableGridFilterHeader(DataGridViewColumnHeaderCell oldHeaderCell)
        {
            ...
            _popUp = new Popup(_popUpText = new WritableGridSearchPopup(oldHeaderCell.OwningColumn.HeaderText.ToString()));
            ...
            WritableGridFilterHeader filterCell =
                oldHeaderCell as WritableGridFilterHeader;
            if (filterCell != null)
            {
        ...
        public  void RemoveFilter()
        {
            ...
            _popUpText.ShowSearch(this.DataGridView, this.OwningColumn.Index, -1, _popUp);
            _popUp.Hide();
        ...
        private WritableGridSearchPopup _popUpText;
        ...
        /// class. 
        /// </summary>
        public WritableGridFilterHeader()
        {
            Assembly Asm = Assembly.GetExecutingAssembly();
        ...
        {
            return new WritableGridFilterHeader(this);
        }
        ...
        public void CallbackMouseDown(DataGridViewCellMouseEventArgs e)
        {
            OnMouseDown(e);
        }
        /// <summary>
        ...
        protected override void OnMouseDown(DataGridViewCellMouseEventArgs e)
        {
                ...
                e.X + cellBounds.Left - scrollingOffset, e.Y + cellBounds.Top))
            {
                ...
                if (e.Button == MouseButtons.Left)
                    ShowDropDownList(e.RowIndex, e.ColumnIndex);
        ...
        /// </summary>
        public  void ShowDropDownList(int _RowIndex, int _ColumnIndex)
        {
         //   Debug.Assert(this.DataGridView != null, "DataGridView is null");
           ...
           // this.DataGridView.InvalidateCell(this);
            ...
            _popUpText.ShowSearch(this.DataGridView, _ColumnIndex, _RowIndex,_popUp);
            this.DataGridView.InvalidateCell(this);
        }
