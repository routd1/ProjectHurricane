...
namespace ICTEAS.WinForms.Utilities
{
    ...
    public class Popup : ToolStripDropDown
    {
        ...
        public void PerformSearchInvoke(string strSearchParam, DataGridView parentGrid)
        {
            ReadnSearchPopUp objSearchControl = (ReadnSearchPopUp)this.Content;
            System.Reflection.MethodInfo info = objSearchControl.GetType().GetMethod("FilterData");
            info.Invoke(objSearchControl, new object[] { strSearchParam, true, parentGrid });
        ...
        public void OnFilterRemoved(Control control)
        {
            if (control == null)
            {
                throw new ArgumentNullException("control");
