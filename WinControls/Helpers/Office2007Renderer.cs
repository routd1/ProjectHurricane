...
namespace ICTEAS.WinForms.Helpers
{
    ...
    public class Office2007Renderer : ToolStripProfessionalRenderer
    {
        ...
        private static int _separatorInset = 30;
        private static float _cutToolItemMenu = 1f;
        private static float _cutContextMenu = 1f;
        private static float _cutMenuItemBack = 1f;
        private static float _contextCheckTickThickness = 2f;
        private static Blend _statusStripBlend;
        #endregion

        #region Static Colors
        #region Deprecated
        //private static Color _c1 = Color.FromArgb(245, 245, 245);//Menu_c1
        //private static Color _c3 = Color.FromArgb(0, 0, 255);//Menu_c3
        //private static Color _c5 = Color.FromArgb(255, 0, 0);//Menu_c5
        //private static Color _c6 = Color.FromArgb(0, 0, 255);//Menu_c6

        //// Menu : Font
        //private static Color _c2 = Color.FromArgb(51, 51, 51);//Menu_c2
        
        //// Menu : Dropdown Background
        //private static Color _c4 = Color.FromArgb(240, 240, 240);//Menu_c4
        
        //// Menu : Tab Gradients
        //private static Color _r5 = Color.FromArgb(255, 255, 255);//Menu_r5
        //private static Color _r6 = Color.FromArgb(228, 228, 228);//Menu_r6
        //private static Color _r7 = Color.FromArgb(175, 175, 175);//Menu_r7
        //private static Color _r8 = Color.FromArgb(228, 228, 228);//Menu_r8

        //// Menu : Tab Border Gradients
        //private static Color _r1 = Color.FromArgb(255, 255, 255);//Menu_r1
        //private static Color _r2 = Color.FromArgb(228, 228, 228);//Menu_r2
        //private static Color _r3 = Color.FromArgb(175, 175, 175);//Menu_r3
        //private static Color _r4 = Color.FromArgb(228, 228, 228);//Menu_r4

        //// Tab Border Highlight (onRollOver)
        //private static Color _r9 = Color.FromArgb(230, 230, 230);//Menu_r9
        //private static Color _rA = Color.FromArgb(150, 150, 150);//Menu_rA

        //// Tab Highlight (onPress)
        //private static Color _rD = Color.FromArgb(255, 255, 255);//Menu_rD
        //private static Color _rE = Color.FromArgb(228, 228, 228);//Menu_rE
        //private static Color _rF = Color.FromArgb(175, 175, 175);//Menu_rF
        //private static Color _rG = Color.FromArgb(228, 228, 228);//Menu_rG

        //// Tab when Pressed (onPress)
        //private static Color _rH = Color.FromArgb(228, 228, 228);//Menu_rH
        //private static Color _rI = Color.FromArgb(190, 190, 190);//Menu_rI
        //private static Color _rJ = Color.FromArgb(228, 228, 228);//Menu_rJ
        //private static Color _rK = Color.FromArgb(228, 228, 228);//Menu_rK

        //// ISOLATED
        //private static Color _rB = Color.FromArgb(0, 255, 0);
        //private static Color _rC = Color.FromArgb(0, 255, 0);
        //private static Color _rL = Color.FromArgb(0, 255, 0);
        //private static Color _rM = Color.FromArgb(0, 255, 0);
        //private static Color _rN = Color.FromArgb(0, 255, 0);
        //private static Color _rO = Color.FromArgb(0, 255, 0);
        //private static Color _rP = Color.FromArgb(0, 255, 0);
        //private static Color _rQ = Color.FromArgb(0, 255, 0);
        //private static Color _rR = Color.FromArgb(0, 255, 0);
        //private static Color _rS = Color.FromArgb(0, 255, 0);
        //private static Color _rT = Color.FromArgb(0, 255, 0);
        //private static Color _rU = Color.FromArgb(0, 255, 0);
        //private static Color _rV = Color.FromArgb(0, 255, 0);
        //private static Color _rW = Color.FromArgb(0, 255, 0);
        //private static Color _rX = Color.FromArgb(0, 255, 0);
        //private static Color _rY = Color.FromArgb(0, 255, 0);
        //private static Color _rZ = Color.FromArgb(0, 255, 0);
        ...
        //private static Color _arrowLight = Color.FromArgb(153, 153, 153);//Menu_arrowLight
        //private static Color _arrowDark = Color.FromArgb(70, 70, 70);//Menu_arrowDark
        //private static Color _separatorMenuLight = Color.FromArgb(235, 235, 235);//Menu_separatorMenuLight
        //private static Color _separatorMenuDark = Color.FromArgb(204, 204, 204);//Menu_separatorMenuDark
        //private static Color _contextMenuBack = _c4;
        
        //// Menu Checkbox Border
        //private static Color _contextCheckBorder = Color.FromArgb(204, 204, 204);//Menu_contextCheckBorder

        //// Menu Checkbox Tick
        //private static Color _contextCheckTick = Color.FromArgb(255, 0, 0);//Menu_contextCheckTick

        //private static Color _statusStripBorderDark = Color.FromArgb(86, 125, 176);//Menu_statusStripBorderDark
        //private static Color _statusStripBorderLight = Color.White;//Menu_statusStripBorderLight
        //private static Color _gripDark = Color.FromArgb(0, 255, 0);//Menu_gripDark
        //private static Color _gripLight = _c5;//Menu_gripLight
        #endregion


        private static Color _c1 = DesignHelper.DoGetColorFromHash("Menu_c1");// Color.FromArgb(245, 245, 245);//Menu_c1
        private static Color _c3 = DesignHelper.DoGetColorFromHash("Menu_c3");//  Color.FromArgb(0, 0, 255);//Menu_c3
        private static Color _c5 = DesignHelper.DoGetColorFromHash("Menu_c5");//  Color.FromArgb(255, 0, 0);//Menu_c5
        private static Color _c6 = DesignHelper.DoGetColorFromHash("Menu_c6");//  Color.FromArgb(0, 0, 255);//Menu_c6

        // Menu : Font
        private static Color _c2 = DesignHelper.DoGetColorFromHash("Menu_c2");//  Color.FromArgb(51, 51, 51);//Menu_c2

        // Menu : Dropdown Background
        private static Color _c4 = DesignHelper.DoGetColorFromHash("Menu_c4");// = Color.FromArgb(240, 240, 240);//Menu_c4

        // Menu : Tab Gradients
        private static Color _r5 = DesignHelper.DoGetColorFromHash("Menu_r5");// Color.FromArgb(255, 255, 255);//Menu_r5
        private static Color _r6 = DesignHelper.DoGetColorFromHash("Menu_r6");// Color.FromArgb(228, 228, 228);//Menu_r6
        private static Color _r7 = DesignHelper.DoGetColorFromHash("Menu_r7");// Color.FromArgb(175, 175, 175);//Menu_r7
        private static Color _r8 = DesignHelper.DoGetColorFromHash("Menu_r8");// Color.FromArgb(228, 228, 228);//Menu_r8

        // Menu : Tab Border Gradients
        private static Color _r1 = DesignHelper.DoGetColorFromHash("Menu_r1");// Color.FromArgb(255, 255, 255);//Menu_r1
        private static Color _r2 = DesignHelper.DoGetColorFromHash("Menu_r2");// Color.FromArgb(228, 228, 228);//Menu_r2
        private static Color _r3 = DesignHelper.DoGetColorFromHash("Menu_r3");// Color.FromArgb(175, 175, 175);//Menu_r3
        private static Color _r4 = DesignHelper.DoGetColorFromHash("Menu_r4");// Color.FromArgb(228, 228, 228);//Menu_r4

        // Tab Border Highlight (onRollOver)
        private static Color _r9 = DesignHelper.DoGetColorFromHash("Menu_r9");// Color.FromArgb(230, 230, 230);//Menu_r9
        private static Color _rA = DesignHelper.DoGetColorFromHash("Menu_rA");// Color.FromArgb(150, 150, 150);//Menu_rA

        // Tab Highlight (onPress)
        private static Color _rD = DesignHelper.DoGetColorFromHash("Menu_rD");// Color.FromArgb(255, 255, 255);//Menu_rD
        private static Color _rE = DesignHelper.DoGetColorFromHash("Menu_rE");// Color.FromArgb(228, 228, 228);//Menu_rE
        private static Color _rF = DesignHelper.DoGetColorFromHash("Menu_rF");// Color.FromArgb(175, 175, 175);//Menu_rF
        private static Color _rG = DesignHelper.DoGetColorFromHash("Menu_rG");// Color.FromArgb(228, 228, 228);//Menu_rG

        // Tab when Pressed (onPress)
        private static Color _rH = DesignHelper.DoGetColorFromHash("Menu_rH");// Color.FromArgb(228, 228, 228);//Menu_rH
        private static Color _rI = DesignHelper.DoGetColorFromHash("Menu_rI");// Color.FromArgb(190, 190, 190);//Menu_rI
        private static Color _rJ = DesignHelper.DoGetColorFromHash("Menu_rJ");// Color.FromArgb(228, 228, 228);//Menu_rJ
        private static Color _rK = DesignHelper.DoGetColorFromHash("Menu_rK");// Color.FromArgb(228, 228, 228);//Menu_rK
        ...
        private static Color _textContextMenuItem = _c2;
        private static Color _arrowDisabled = _c1;
        private static Color _arrowLight = DesignHelper.DoGetColorFromHash("Menu_arrowLight");// Color.FromArgb(153, 153, 153);//Menu_arrowLight
        private static Color _arrowDark = DesignHelper.DoGetColorFromHash("Menu_arrowDark");// Color.FromArgb(70, 70, 70);//Menu_arrowDark
        private static Color _separatorMenuLight = DesignHelper.DoGetColorFromHash("Menu_separatorMenuLight");// Color.FromArgb(235, 235, 235);//Menu_separatorMenuLight
        private static Color _separatorMenuDark = DesignHelper.DoGetColorFromHash("Menu_separatorMenuDark");// Color.FromArgb(204, 204, 204);//Menu_separatorMenuDark
        private static Color _contextMenuBack = _c4;

        // Menu Checkbox Border
        private static Color _contextCheckBorder = DesignHelper.DoGetColorFromHash("Menu_contextCheckBorder");// Color.FromArgb(204, 204, 204);//Menu_contextCheckBorder

        // Menu Checkbox Tick
        private static Color _contextCheckTick = DesignHelper.DoGetColorFromHash("Menu_contextCheckTick");// Color.FromArgb(255, 0, 0);//Menu_contextCheckTick

        private static Color _statusStripBorderDark = DesignHelper.DoGetColorFromHash("Menu_statusStripBorderDark");// Color.FromArgb(86, 125, 176);//Menu_statusStripBorderDark
        private static Color _statusStripBorderLight = DesignHelper.DoGetColorFromHash("Menu_statusStripBorderLight");// Color.White;//Menu_statusStripBorderLight
        private static Color _gripDark = DesignHelper.DoGetColorFromHash("Menu_gripDark");// Color.FromArgb(0, 255, 0);//Menu_gripDark
        private static Color _gripLight = _c5;

        //private static GradientItemColors _itemContextItemEnabledColors = new GradientItemColors(_r1, _r2, _r3, _r4, _r5, _r6, _r7, _r8, Color.FromArgb(217, 203, 150), Color.FromArgb(192, 167, 118));// CHANGED
        private static GradientItemColors _itemContextItemEnabledColors = new GradientItemColors(_r1, _r2, _r3, _r4, _r5, _r6, _r7, _r8, Color.FromArgb(228, 228, 228), Color.FromArgb(228, 228, 228));
        ...
        private static GradientItemColors _itemToolItemPressedColors = new GradientItemColors(_rD, _rE, _rF, _rG, _rH, _rI, _rJ, _rK, _r9, _rA); //TO CHANGE
