...
namespace ICTEAS.WinForms.Helpers
{
            ...
            else
            {
                ...
                if (_keeppress)
                {
                    ...
                    try
                    {
                        ...
                        {
                            if (typeof(GradientButton) == _control.GetType() & _control.Name != this.Name)
                            {
                                ((GradientButton)(_control))._ispressed = false;
                                ((GradientButton)(_control)).UpdateLeave();
                            }
                        }
                    }
                    catch { }
    ...
    public class RibbonColor
    {
        ...
        public float HC 
        {
            ...
            set 
            {
                hc = (int)System.Math.Min(value, 359); 
                hc = (int)System.Math.Max(hc, 0); 
            }
        }
